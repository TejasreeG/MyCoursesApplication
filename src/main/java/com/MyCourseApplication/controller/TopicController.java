...
public class TopicController {
	...
	public ResponseEntity<Topic> CreateTopic(@RequestBody Topic topic){
		Course course = courseRepository.findOne(topic.getC_id());
		course.getTopic().add(course);
	...
	public ResponseEntity<Topic> UpdateTopic(@RequestBody Topic topic)throws Exception{
